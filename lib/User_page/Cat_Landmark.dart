...
class CategoryLandmark extends StatefulWidget {
  @override
  _CategoryLandmarkState createState() => _CategoryLandmarkState();
}

class _CategoryLandmarkState extends State<CategoryLandmark> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Landmark',style: heading1,),
        actions: [
          PopupMenuButton(
            onSelected: (value) {
              setState(() {
