...
class CategoryCafe extends StatefulWidget {
  @override
  _CategoryCafeState createState() => _CategoryCafeState();
}

class _CategoryCafeState extends State<CategoryCafe> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Cafe',style: heading1,),
        actions: [
          PopupMenuButton(
            onSelected: (value) {
              setState(() {
