...
class CategoryNature extends StatefulWidget {
  @override
  _CategoryNatureState createState() => _CategoryNatureState();
}

class _CategoryNatureState extends State<CategoryNature> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Nature',style: heading1,),
        actions: [
          PopupMenuButton(
            onSelected: (value) {
              setState(() {
